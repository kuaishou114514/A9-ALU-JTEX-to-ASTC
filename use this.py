...
class JTEXParser:
    ...
    def _parse_header(self):
        ...
        # 偏移0x1d的uint16小端序: 真实纹理宽度
        # 例如: 256=0x0100, 512=0x0200, 1024=0x0400, 2048=0x0800
        self.width = struct.unpack_from('<H', self.data, 0x1d)[0]
        
        if self.width >= 64 and self.width <= 8192:
            ...
            if width_log2 >= 6 and width_log2 <= 13:  # 64到8192
